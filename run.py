...
def get_last_5_entries_sales():
    ...
    print(f"\n-----\nGetting last five entries....\n-----\n")
    sales = SHEET.worksheet("sales")
    columns = []
    
    for i in range(sales.row_count):
        column = sales.col_values(i+1)
        if column == []:
            break
        else:
            columns.append(column[-5:]) 
    
    print(f"\n-----\nLast five entries downloaded....\n-----\n")
    
    return columns
        

def update_stock_recommendation(data):
    """
...
def main():
    ...
    stock_recommendations = update_stock_recommendation(sales_columns)
